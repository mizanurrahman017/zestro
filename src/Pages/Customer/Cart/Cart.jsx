...
const Cart = () => {
    ...
    const handlePlaceOrder = async () => {
        ...
        try {
            ...
            saveOrderToHistory(orderRef.id);
        ...
        return (
            <div className="min-h-screen bg-[#F7F5EF] flex items-center justify-center px-5">
                <div className="text-center max-w-md">
                    ...
                    <Link
                        to="/"
                        className="inline-flex items-center gap-2 mt-7 px-7 py-3.5 rounded-xl bg-[#252525] text-white font-semibold hover:bg-[#9A8654] transition"
                    >
    ...
    return (
        <div className="min-h-screen bg-[#F7F5EF] py-10 md:py-14">
            <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-12">
                ...
                {orderError && (
                    <div className="mb-7 bg-red-50 border border-red-200 text-red-600 px-5 py-4 rounded-xl text-center">
                        {orderError}
                    </div>
                )}
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-5">
                        ...
                        {cartItems.map((item) => (
                            <div
                                key={item.id}
                                className="bg-white border border-[#E0DDD4] rounded-3xl p-4 md:p-5 shadow-sm"
                            >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex justify-between gap-3">
                                            ...
                                            <button
                                                ...
                                                className="w-9 h-9 rounded-xl bg-red-50 text-red-500 flex items-center justify-center hover:bg-red-500 hover:text-white transition flex-shrink-0"
                                            >
                                        ...
                                        <div className="flex items-center justify-between mt-4">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="w-9 h-9 rounded-xl bg-[#E8E4D9] text-[#252525] flex items-center justify-center hover:bg-[#D8D3C6] transition"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className="w-9 h-9 rounded-xl bg-[#252525] text-white flex items-center justify-center hover:bg-[#9A8654] transition"
                                                >
                    ...
                    <div>
                        <div className="bg-white border border-[#E0DDD4] rounded-3xl p-6 md:p-7 shadow-sm lg:sticky lg:top-24">
                            ...
                            <button
                                ...
                                className="w-full mt-7 py-4 rounded-xl bg-[#252525] text-white font-semibold hover:bg-[#9A8654] transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed"
                            >
                                {placingOrder
                                    ? "Placing Order..."
                                    : "Place Order"}
                            ...
                            <Link
                                to="/"
                                className="flex items-center justify-center gap-2 mt-4 py-3 rounded-xl border border-[#D8D3C6] text-[#252525] font-semibold hover:bg-[#E8E4D9] transition"
                            >
